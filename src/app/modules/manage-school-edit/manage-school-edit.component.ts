...
export class ManageSchoolEditComponent implements OnInit, AfterViewInit {

  displayedColumns: string[] = ['idSchool', 'name', 'size', 'district', 'email', 'tel',
                                'address', 'junior', 'senior', 'director', 'nTeacher',
                                'nPersonnel', 'teachingStyle', 'openClass', 'action'];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ManageSchoolEditComponent> ,
